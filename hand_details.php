...
$query_RS_suits = "SELECT `king_called`, count(`king_called`) as king_amount, sum(`points`) as points FROM hand WHERE 'king_called' IS NOT NULL GROUP BY `king_called` ORDER BY king_amount DESC limit 4";
